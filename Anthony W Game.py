...
courts = Room("NBA2K" 'basketball_courts', 'neighborhood', "store", "clothes_store")
basketball_courts = Room("NBA 2K 3s COURTS", "NBA 2K DOTS", "NBA 2K 2s COURTS")
neighborhood = Room("team practice facility", "foot_locker_store", "basketball_courts", "2K zone", "the venue")
